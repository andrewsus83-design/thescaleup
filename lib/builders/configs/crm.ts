  ...
  steps: [
    {
      ...
      fields: [
        ...
        {
          type: "multiselect",
          label: "Tahapan pipeline (standar)",
          key: "pipeline_stages",
          hint: "Untuk mode Rekomendasi Sistem: centang tahapan yang dilalui. Setiap kontak bergerak dari kiri ke kanan.",
          options: [
            { value: "lead_baru", label: "Lead Baru", desc: "Baru masuk, belum dihubungi" },
            { value: "prospek", label: "Prospek / Qualified", desc: "Sudah direspon & tertarik" },
            { value: "followup", label: "Follow-up", desc: "Sedang di-nurture / menunggu keputusan" },
            { value: "negosiasi", label: "Negosiasi", desc: "Tawar harga / kirim penawaran" },
            { value: "closing", label: "Closing / Deal", desc: "Sudah bayar / jadi pelanggan" },
            { value: "repeat", label: "Repeat / Retensi", desc: "Pelanggan lama untuk repeat order" },
            { value: "lost", label: "Lost / Batal", desc: "Tidak jadi, untuk analisa alasan" },
          ],
        },
        {
          type: "textarea",
          label: "Tahapan custom (opsional)",
          key: "custom_stages",
          placeholder:
            "Satu tahap per baris, urut kiri → kanan:\nLead Baru\nQualified\nFollow-up\nClosing\nRepeat",
          hint: "Isi hanya jika Anda memilih 'Susun Sendiri'. Kosongkan untuk memakai tahapan standar di atas.",
        },
        {
          type: "textarea",
    ...
    },
    {
      ...
      fields: [
        ...
        },
        {
          ...
          key: "lead_sources",
          hint: "Pilih semua channel tempat calon pelanggan menghubungi Anda. Dipakai untuk ukur channel mana paling untung.",
          options: [
