...
export const adminNav: { href: string; label: string; icon: LucideIcon }[] = [
  ...
  { href: "/admin/scalehub", label: "Hub", icon: Newspaper },
...
export const API_PROVIDERS: { key: string; label: string; hint: string }[] = [
  ...
  { key: "dataforseo_login", label: "DataForSEO Login", hint: "email/login akun DataForSEO" },
  { key: "dataforseo", label: "DataForSEO Password", hint: "password / API key DataForSEO (Basic auth)" },
